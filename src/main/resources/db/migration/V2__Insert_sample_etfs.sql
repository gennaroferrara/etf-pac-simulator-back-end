-- V2__insert_sample_etfs.sql

INSERT INTO etfs (
    id, name, ticker, expense, risk, sector, aum, dividend,
    beta, sharpe, max_drawdown, ytd, one_year, three_year, five_year
) VALUES
...
('emerging',     'FTSE Emerging Markets UCITS ETF','VFEM', 0.22, 'VERY_HIGH','Emerging Mkts','3.2B', '2.4%', 1.15, 0.65, -42.1, 8.9, 12.5, 3.2, 6.8),
...
('small_cap',    'FTSE Dev Small Cap UCITS ETF',   'VSML', 0.25, 'HIGH', 'Small Cap',       '0.8B', '1.9%', 1.12, 0.76, -38.9,14.7,19.4,7.8,10.5),
